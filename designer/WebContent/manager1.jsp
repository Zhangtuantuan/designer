...
<div class="dn_main clear">
 <div class="dn_nav_con xg clear">
  <div class="dnc_clsLine ssbtn">
            <a  href="./show">设计师推优</a>
            <a  class="active" href="./show1">案例推优</a>
        </div>
</div>
		  ...
		  <s:if test="#designer.status1!=null  && (#designer.status1.intValue()==3  || #designer.status1.intValue()==4)" >
			<div class="main_requirements">
              ...
              <s:if test="status1.intValue()==3">
                <div class="col_05 fl req_status"><a href="recommendE.action?designer.designerId=<s:property value='designerId'/>&example.name=<s:property value='message'/>"><font color="red">推优</font></a></div>
              </s:if>
