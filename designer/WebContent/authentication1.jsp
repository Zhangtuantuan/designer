...
<div class="dn_main clear">
 <div class="dn_nav_con xg clear">
  <div class="dnc_clsLine ssbtn">
            <a  href="./show2">未认证</a>
            <a class="active" href="./show3">已认证</a>
        </div>
</div>
...
<a class="paging_a paging_bg"  href=authentication1.jsp?ToPage=<%=bpage-1%>>
<div class="triangle_left"></div></a></li>
<li class="paging_lists">
<a class="paging_a paging_a_selected" href=authentication1.jsp?ToPage=<%=bpage%>><%=bpage %></a></li>
<li class="paging_lists"><a class="paging_a paging_bg"  href=authentication1.jsp?ToPage=<%=bpage+1%>>
